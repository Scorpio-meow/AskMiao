...
| [ADR-0004](./0004-tool-admin-permissions-and-subprocess-isolation.md) | 工具管理權限、MCP 子行程隔離與逐跳 SSRF 驗證 | 已通過 (Accepted) | 2026-09-25 | MCP 伺服器與自訂 API 工具只開放管理員管理，stdio 子行程不繼承後端機密環境變數，出站請求的每次轉址都重新做 SSRF 驗證；補充 ADR-0002 |
