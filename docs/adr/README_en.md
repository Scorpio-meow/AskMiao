...
| [ADR-0004](./0004-tool-admin-permissions-and-subprocess-isolation_en.md) | Tool Management Permissions, MCP Subprocess Isolation & Per-Hop SSRF Validation | Accepted | 2026-09-25 | MCP servers and custom API tools are managed by admins only, stdio subprocesses no longer inherit backend secrets, and every redirect of an outbound request is SSRF-validated again; extends ADR-0002 |
